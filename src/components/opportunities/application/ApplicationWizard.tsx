...
import { ArrowLeft01Icon, ArrowRight01Icon, CheckmarkCircle02Icon, SentIcon } from "@hugeicons/core-free-icons";
...
export function ApplicationWizard({
  ...
  async function submit(event: FormEvent) {
    ...
    const invalidFile = [document, coverDocument].find(
      (file) =>
        file && (!isSupportedFile(file) || file.size > 10 * 1024 * 1024),
    );
    if (invalidFile) {
  ...
  return (
    <aside className={styles.readiness}>
      ...
      <p>
        {opportunity.is_open
          ? "Review the role, prepare your documents, and submit with confidence."
          ...
          >
            <header>
              <div>
                ...
                <h2 id="application-title">
                  {step === 4 ? "Application submitted" : opportunity.title}
                </h2>
              </div>
              <button
            ...
            {step === 1 ? (
              <div className={styles.step}>
                ...
                <dl>
                  ...
                  <div>
                    <dt>Work mode</dt>
                    <dd>{opportunity.work_flexibility ?? "Not specified"}</dd>
                  </div>
                  <div>
                    <dt>Location</dt>
            ...
            {step === 2 ? (
              <div className={styles.step}>
                ...
                <h3>Make your interest clear</h3>
                <label>
                  <span>
                    Cover letter <small>Optional · 5,000 characters</small>
                  </span>
                  <textarea
                    maxLength={5000}
                    onChange={(event) => setCoverLetter(event.target.value)}
                    placeholder="Explain why this opportunity fits your goals…"
                    value={coverLetter}
                  />
                </label>
                {type === "job-listings" ? (
                  <label>
                    <span>
                      Experience summary{" "}
                      <small>Optional · 3,000 characters</small>
                    </span>
                    <textarea
                      maxLength={3000}
              ...
              <form className={styles.step} onSubmit={submit}>
                ...
                {latestDocument ? (
                  <div className={styles.review}>
                    <strong>Primary CV</strong>
                    <p>
                      {latestDocument.file_name} · uploaded{" "}
                ...
                <div className={styles.review}>
                  ...
                  <p>
                    ...
                    {opportunity.posted_by.name}. You cannot submit the same
                    opportunity twice.
                  </p>
                </div>
                {error ? (
            ...
            {step === 4 ? (
              <div className={styles.success}>
                <HugeIcon icon={CheckmarkCircle02Icon} size={46} />
                <h3>Your application is on its way.</h3>
                <p>Your submission is secure and ready for review.</p>
                <AuthButton
                  className={styles.action}
