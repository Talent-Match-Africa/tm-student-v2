...
export const metadata: Metadata = {
  title: "Dashboard | Talent Match Student",
  description: "Review your Talent Match student journey and next actions.",
};
...
export default async function DashboardPage() {
  ...
  if (!result.ok)
    return <DashboardErrorState message={readDashboardError(result.payload)} />;
  const displayName =
    profile.profile?.displayName?.trim() || profile.name?.trim() || "there";
  return (
    <DashboardWorkspace
